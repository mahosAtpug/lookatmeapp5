...
import {View,StyleSheet,Platform,Text,Image,TouchableOpacity,SafeAreaView} from "react-native";
          ...
          <View style={styles.contentContainer}>
            <View style={styles.textContainer}>
              <Text style={styles.contentText}>
                Filter Me! will not only make you look cool, but help you be more popular
              </Text>
            </View>
