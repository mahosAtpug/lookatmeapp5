...
const data = {
  Crown: [
    { id: "crown1", src: require("../assets/crown1.png") },
    { id: "crown2", src: require("../assets/crown2.png") },
    { id: "crown3", src: require("../assets/crown3.png") }
  ],
  Flowers: [
    { id: "flower1", src: require("../assets/flower1.png") },
    { id: "flower2", src: require("../assets/flower2.png") },
    { id: "flower3", src: require("../assets/flower3.png") }
  ],
  Hairs: [{ id: "hair1", src: require("../assets/hair1.png") }],
  Hats: [
    { id: "hat1", src: require("../assets/hat1.png") },
    { id: "hat2", src: require("../assets/hat2.png") }
  ],
  Extra: [
    { id: "pic", src: require("../assets/pic.png") }
...
const filters = {
  ...
  "flower2": {
    src: require("../assets/flower2.png"),
    width: 1.2,
    height: 0.55,
    left: 0.36,
    right: 0.15,
  ...
  "flower3": {
    src: require("../assets/flower3.png"),
    width: 5,
    height: 0.8,
    left: 0.46,
    right: 0.15,
